...
export const ArchiveView: React.FC<ArchiveViewProps> = ({ user, logs, documents, onNavigate, onSupportClick }) => {
   return (
      <div className="min-h-screen bg-[#F5F7FA] flex font-sans">

         <Sidebar user={user} currentView="ARCHIVE" onNavigate={onNavigate} onSupportClick={onSupportClick} />
