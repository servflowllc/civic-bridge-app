...
export const SettingsView: React.FC<SettingsViewProps> = ({ user, onNavigate, onUpdateUser, onLogout, onSupportClick }) => {
    ...
    return (
        <div className="min-h-screen bg-[#F5F7FA] flex font-sans">
            <Sidebar user={user} currentView="SETTINGS" onNavigate={onNavigate} onSupportClick={onSupportClick} />
                    ...
                    <div className="space-y-6">
                        ...
                        <div className={`rounded-2xl p-6 shadow-sm border relative overflow-hidden transition-all ${user.isPro ? 'bg-[#002e6d] border-[#002e6d] text-white' : 'bg-white border-gray-200'}`}>
                            ...
                            <button
                                ...
                                className={`w-full py-3 rounded-xl font-bold text-sm transition-all ${user.isPro
